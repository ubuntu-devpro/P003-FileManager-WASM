# FA001-C-User: user@others.com login
...
| Case ID | FA001-C-User |
| Case Name | user@others.com login |
| Stage | S1 |
...
```json
{
  ...
  "jwt_claims": {
    "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress": "user@others.com",
