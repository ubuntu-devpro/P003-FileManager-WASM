# FA001-A-Admin: admin@devpro.com.tw login
...
| Case ID | FA001-A-Admin |
| Case Name | admin@devpro.com.tw login |
| Stage | S1 |
...
```json
{
  ...
  "jwt_claims": {
    "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress": "admin@devpro.com.tw",
    "http://schemas.microsoft.com/ws/2008/06/identity/claims/role": "Admin",
    "domain": "devpro.com.tw",
    "exp": 1776518064,
...
- PASS — admin@devpro.com.tw login
